...
<body>
    ...
    <%--    标题--%>
        ...
        <div class="row">
            <%--            分页文字信息--%>
            <div class="col-md-6">
                当前第${pageInfo.getPageNum()}页，共${pageInfo.getTotal()}条记录。
            </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${pageInfo.isHasPreviousPage()}">
                            <li>
                                <a href="${APP_PATH}/emps?pn=${pageInfo.getPageNum() - 1}" aria-label="Previous">
                        ...
                        <c:if test="${pageInfo.isHasNextPage()}">
                            <li>
                                <a href="${APP_PATH}/emps?pn=${pageInfo.getPageNum() + 1}" aria-label="Next">
